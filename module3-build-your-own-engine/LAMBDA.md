...
## 1. Copy module3-build-your-own-engine to the instance
...
| rsync: `./module3-build-your-own-engine/` not found | You're already in `module3-build-your-own-engine/` — use `./` as source |
